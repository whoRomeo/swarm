...
# How to Use hermes-agent (Complete Tutorial)

Complete tutorial for hermes-agent. Learn how to install, configure, and use hermes-agent for your projects.
...
```
[INTRO - 0:00-0:30]
"Want to learn how to use hermes-agent? In this video, I'll walk you through everything from installation to your first project."
...
"Let's build something real with hermes-agent..."
